...
const Header = () => {
  return (
    <header className="flex 2xl:h-[70vh] h-[90vh] md:h-screen relative top-[84px] bg-brand2 bg-cover">
    <div className="w-full h-full absolute top-0 left-0 right-0 bg-brand2 opacity-[0.5]">
      ...
      <div className="absolute w-full h-full">
        <div className="flex flex-col h-full items-center justify-center max-w-[1070px] mx-auto">
          <h1 className="font-mon text-center text-[#fff] mr-3 text-[20px] md:text-[42px] font-[500]">
